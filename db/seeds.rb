User.create!([
  {email: "ninawinkler@me.com", password: "Password1!", firstname: "Nina", lastname: "Winkler", admin: false},
  {email: "admin@admin.com", password: "Password1!", firstname: "Sarah", lastname: "Johnson", admin: true},
  {email: "jim@me.com", password: "Password1!", firstname: "Jim", lastname: "Ackles", admin: false},
  {email: "sarah@me.com", password: "Password1!", firstname: "Sarah", lastname: "Lakewood", admin: false},
  {email: "movie@me.com", password: "Password1!", firstname: "Lisa", lastname: "Spring", admin: false},
  {email: "davey@me.com", password: "Password1!", firstname: "Davey", lastname: "Feimer", admin: false},
  {email: "davey@helps.com", password: "Password1!", firstname: "David", lastname: "Leigh", admin: false},
  {email: "boolean@me.com", password: "Password1!", firstname: "Julian", lastname: "Prince", admin: true},
  {email: "newuser@me.com", password: "Password1!", firstname: "Margaret", lastname: "Peters", admin: false},
  {email: "Jill@me.com", password: "Password1!", firstname: "Jill", lastname: "Savage", admin: false},
  {email: "newadmin@admin.com", password: "Password1!", firstname: "Darcy", lastname: "Fell", admin: true},
  {email: "scott@me.com", password: "Password1!", firstname: "Scott", lastname: "Chattertown", admin: false},
  {email: "jessica@me.com", password: "Password1!", firstname: "Jessica", lastname: "James", admin: false},
  {email: "jen@me.com", password: "Password1!", firstname: "Jennifer", lastname: "West", admin: false},
  {email: "tim@me.com", password: "Password1!", firstname: "Tim", lastname: "Finley", admin: false},
  {email: "chris@me.com", password: "Password1!", firstname: "Chris ", lastname: "Nixon", admin: true},
  {email: "don@me.com", password: "Password1!", firstname: "Don", lastname: "Finatzer", admin: true}
])
Movie.create!([
